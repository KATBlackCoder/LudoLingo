...
export default {
  ...
  projects: {
    ...
    dashboard_description: 'Manage your localization projects',
    create_project: 'Create project',
    edit_project: 'Edit project',
    project_name: 'Project name',
    project_name_placeholder: 'My awesome game',
    project_description: 'Description',
    project_description_placeholder: 'Optional project description',
    game_path: 'Game path',
    game_path_placeholder: 'Select game folder',
    ...
    no_projects_description: 'Create your first project to start localizing games',
    create_first_project: 'Create first project',
    project_created: 'Project created successfully',
    project_updated: 'Project updated successfully',
    project_deleted: 'Project deleted successfully',
    delete_project_confirm: 'Confirm deletion',
    delete_project_message: 'Are you sure you want to delete this project?',
    delete_project_warning: 'This action is irreversible and will delete all associated data.',
    view: 'View',
    copy: 'Copy'
  },
  games: {
